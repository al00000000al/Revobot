...
case 'mail':
case 'меил':
	$response = (new \Revobot\Commands\MailCmd($input))->exec();
	break;
case 'mycommands':
case 'моикомманды':
...
case 'порф':
case 'порфирьевич':
	$response = (new \Revobot\Commands\PorfirevichCmd($input))->exec();
	break;
case 'pukvy':
case 'пуквы':
...
case 'sber':
case 'сбер':
	$response = (new \Revobot\Commands\SberCmd($input))->exec();
	break;
case 'send':
case 'сенд':
