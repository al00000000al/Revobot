...
case 'баланс':
	...
	break;
case 'ban':
	$response = (new \Revobot\Commands\BanCmd($input, $bot))->exec();
	break;
case 'bank':
	$response = (new \Revobot\Commands\BankCmd($input, $bot))->exec();
	break;
case 'bash':
case 'баш':
...
case 'coin':
case 'flip':
	$response = (new \Revobot\Commands\CoinFlipCmd($input, $bot))->exec();
	break;
case 'cmd':
case 'кмд':
case 'команда':
...
case 'исброс':
	...
	break;
case 'clearpermanencontext':
	$response = (new \Revobot\Commands\Gpt\ClearPermanentContextCmd($input, $bot))->exec();
	break;
case 'context':
case 'контекст':
case 'c':
...
case 'permanentcontext':
	$response = (new \Revobot\Commands\Gpt\PermanentContextCmd($input, $bot))->exec();
	break;
case 'help':
case 'хэлп':
case 'хлеп':
